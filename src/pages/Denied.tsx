...
export function Denied({ label }: { label: string }) {
  ...
  return (
    <Card className="mt-12 max-w-[520px] p-[22px]">
      ...
      <div className="text-[12.5px] font-normal leading-relaxed text-muted-70">
      ...
      <div className="mt-4 flex gap-2">
        <Button variant="primary" onClick={() => setRole('admin')}>
          Switch to Admin
        </Button>
